          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-black/10 dark:border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-800 dark:text-gray-400 mb-4">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nostrum, eligendi velit.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {["React", "Redux", "Tailwind", "Typescript"].map((tech, key) => (
                  <span
                    key={key}
            ...
            <div
              className="
              glass p-6 rounded-xl border border-black/10 dark:border-white/10 
